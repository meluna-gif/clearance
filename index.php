    ...
    if (empty($errors)) {
        ...
        try {
            ...
            if (!empty($current_password)) {
                ...
                $user = $db->fetchSingle($sql_check, [':user_id' => $auditor->getId()]);
            ...
            if (empty($errors)) {
                ...
                logAction($auditor->getId(), 'profile_update', "Updated profile information");
        ...
        <div class="col-md-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body text-center">
                    ...
                    <h4><?php echo htmlspecialchars($auditor->getFullName()); ?></h4>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    $sql = "SELECT * FROM audit_logs 
                            ...
                            LIMIT 5";
                    $activities = $db->fetchAll($sql, [':user_id' => $auditor->getId()]);
                    ?>
                    ...
                    <?php if (!empty($activities)): ?>
                        ...
                        <div class="text-center mt-2">
                            <a href="audit_logs.php?user_id=<?php echo $auditor->getId(); ?>" 
                    ...
                    <form method="POST" action="">
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="full_name" name="full_name" 
                                       value="<?php echo htmlspecialchars($auditor->getFullName()); ?>" required>
                            </div>
                            <div class="col-md-6">
                                <label for="email" class="form-label">Email *</label>
                                <input type="email" class="form-control" id="email" name="email" 
                                       value="<?php echo htmlspecialchars($auditor->getEmail()); ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="username" 
                                   value="<?php echo htmlspecialchars($auditor->getUsername()); ?>" readonly>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <ul class="list-unstyled">
                                <li class="mb-2">
                                    ...
                                    <?php echo date('M j, Y', strtotime($auditor->getCreatedAt())); ?>
                                </li>
                                <li class="mb-2">
                                    <strong>Last Login:</strong> 
                                    <?php echo $auditor->getLastLogin() ? date('M j, Y g:i A', strtotime($auditor->getLastLogin())) : 'Never'; ?>
                                </li>
                                <li class="mb-2">
                        ...
                        <div class="col-md-6">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li class="mb-2">
                                    ...
                                    $result = $db->fetchSingle($sql, [':user_id' => $auditor->getId()]);
                                    echo $result['count'];
                                    ?>
                                </li>
                                <li class="mb-2">
                                    <strong>Today's Logs:</strong> 
                                    <?php
